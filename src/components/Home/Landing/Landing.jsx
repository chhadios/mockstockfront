        ...
        <div className="items-center lg:flex">
          <div className="w-full lg:w-1/2">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-400 mb-6"> { user?.result ? <strong>Mock Stocks - </strong> : "" } The trading platform for everyone. Start off with a $100k in imaginary currency to see how you perform in the markets.</p>
